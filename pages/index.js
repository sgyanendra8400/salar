...
import Footer from "../src/layout/footer/dweb";
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage: "url(http://localhost:3000/img/main_banner.jpg)",
        }}
      >
            ...
            <div className="col-lg-9 z-index-2 border-radius-xl mt-n10 mx-auto py-3 blur shadow-blur">
              <div className="row">
                <div className="col-md-3 position-relative">
                  <img src="./img/grocery.jpg" className="category-image" />
                      ...
                      <div className="card-body">
                        ...
                        <p>
                          ...
                          <p className="mt-1">
                            ...
                            <div>&#8377; {product?.mrp}</div>
                            <div>
                              M.R.P: <del>&#8377;{product?.crossPrice}</del>
                            </div>
                            <div className="mt-2">
                              <button
                                type="button"
                ...
                <div class="row">
                  <div class="col-lg-4 my-auto">
                    ...
                    <p class="text-white opacity-8">
                      We created many examples for pages like Signup, Signin,
                      Forgot Password, 2FA Authentification and so on. Just
                      choose between a Basic Design, an illustration or a cover
